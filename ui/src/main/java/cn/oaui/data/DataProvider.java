...
public class DataProvider  {
    ...
    public DataProvider(View view,AttributeSet attrs){
        TypedArray typedarray=view.getContext().obtainStyledAttributes(attrs, cn.oaui.R.styleable.DataListView);
        ...
        isDataFromSql=typedarray.getBoolean(cn.oaui.R.styleable.DataListView_isDataFromSql,false);
