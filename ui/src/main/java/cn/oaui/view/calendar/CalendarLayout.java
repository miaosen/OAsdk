...
public class CalendarLayout extends CustomLayout {
    ...
    public void initData() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            DateView dateView = (DateView) ViewUtils.inflatView(getContext(), cn.oaui.R.layout.ui_view_calendar_date_view, viewPager, false);
    ...
    public int setXmlLayout() {
        return cn.oaui.R.layout.ui_view_calendar_layout;
    }
