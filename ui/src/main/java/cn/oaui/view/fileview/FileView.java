...
//    @ViewInject
//    public LinearLayout ln_add, ln_search,ln_sort,ln_tip, ln_header, ln_edit_right,ln_cancle,ln_sure;
//    @ViewInject
//    LinearLayout ln_share, ln_move, ln_edit_tail, ln_edit_head, ln_more, ln_copy, ln_delete;
////    @ViewInject
...
//                Intent intent = new Intent(getContext(), CollectAddAct.class);
//                Activity activity = (Activity) getContext();
//                intent.putExtra(KEY_CUR_COLLECT_DIR, curCollectDir);
...
//    }
//
//    public void onItemModifyListener(View convertView, RowObject row, int position, BaseFillAdapter.ViewHolder holder) {
...
//        String name = row.getString("name");
//       CollectionData.sortRowsByType(rows,name);
//        RowObject setting = SettingView.getSetting();
//        setting.put(SortDialogListView.KEY_SORT_TYPE,name);
//        SettingView.saveSetting(setting);
//        listAdapter.notifyDataSetChanged();
//
//    }
//
...
//        View view = ViewUtils.inflatView(context, R.layout.collect_add_folder_alert);
//        EditText editText = view.findViewById(R.id.ed);
//        TagView tagView = view.findViewById(R.id.tagView);
//        tagView.setVisibility(GONE);
//        File file = new File(path);
//        editText.setText(file.getName());
//        AlertDialog alertDialog = ViewUtils.showAlertEditDialog(getContext(),
//                ResourceHold.getString(R.string.modify), view,
//                ResourceHold.getString(R.string.sure),
//                ResourceHold.getString(R.string.cancle),
//                new DialogInterface.OnClickListener() {//添加"Yes"按钮
//                    @Override
...
//                        File file = new File(path);
//                        String parent = file.getParent();
//                        String newSavePath = parent + "/" + text;
...
//        View view = ViewUtils.inflatView(context, R.layout.collect_add_folder_alert);
//        EditText tag = view.findViewById(R.id.tag);
//        tag.setVisibility(GONE);
//        AlertDialog alertDialog = ViewUtils.showAlertEditDialog(context,
//                ResourceHold.getString(R.string.add_folder), view,
//                ResourceHold.getString(R.string.sure),
//                ResourceHold.getString(R.string.cancle),
//                new DialogInterface.OnClickListener() {//添加"Yes"按钮
//                    @Override
//                    public void onClick(DialogInterface dialogInterface, int i) {
//                        EditText editText = view.findViewById(R.id.ed);
//                        boolean dir = FileUtils.createDir(curCollectDir + "/" + editText.getText() + "/");
//                        try {
//                            Field field = dialogInterface.getClass().getSuperclass().getDeclaredField("mShowing");
//                            field.setAccessible(true);
//                            if (StringUtils.isEmpty(editText.getText() + "")) {
//                                field.set(dialogInterface, false);
//                                ViewUtils.toast("文件夹名称不能为空！");
//                            } else if (dir) {
//                                field.set(dialogInterface, true);
//                                loadData(curCollectDir);
//                            } else {
//                                field.set(dialogInterface, false);
//                                ViewUtils.toast("文件夹已存在！");
//                            }
//                        } catch (Exception e) {
//                            e.printStackTrace();
//                        }
...
//    }
//
//    public LinearLayout getLn_header() {
//        return ln_header;
//    }
//
//    public void setLn_header(LinearLayout ln_header) {
//        this.ln_header = ln_header;
//    }
//
//    public LinearLayout getLn_add() {
//        return ln_add;
//    }
//
//    public void setLn_add(LinearLayout ln_add) {
//        this.ln_add = ln_add;
//    }
//
