...
public class DataListView extends CustomLayout implements FormAdpater {
    ...
    boolean autoInvoke;
    boolean enablePage=true,enableRefresh=true,enableLoadMore=true,isCanScroll;
    ...
    public int setXmlLayout() {
        return cn.oaui.R.layout.ui_view_autolistview;
    }
    ...
    private void readAttr(AttributeSet attrs) {
        TypedArray typedarray = getContext().obtainStyledAttributes(attrs, cn.oaui.R.styleable.DataListView);
        itemLayoutId = typedarray.getResourceId(cn.oaui.R.styleable.DataListView_itemLayout, -1);
        url = typedarray.getString(cn.oaui.R.styleable.DataListView_url);
        if (StringUtils.isEmpty(url)) {
            url = GLOBAL_URL;
        }
        urlSuffix = typedarray.getString(cn.oaui.R.styleable.DataListView_urlSuffix);
        tempUrlSuffix = typedarray.getString(cn.oaui.R.styleable.DataListView_tempUrlSuffix);
        dataExpression = typedarray.getString(cn.oaui.R.styleable.DataListView_dataExpression);
        autoInvoke = typedarray.getBoolean(cn.oaui.R.styleable.DataListView_autoInvoke, true);
        enablePage = typedarray.getBoolean(cn.oaui.R.styleable.DataListView_isEnablePage, true);
        isCanScroll = typedarray.getBoolean(cn.oaui.R.styleable.DataListView_isCanScroll, true);
        if(!isCanScroll){
            noScroll();
        }
        String param = typedarray.getString(cn.oaui.R.styleable.DataListView_param);
        readParam(param);
        typedarray.recycle();
    }
    ...
    public void initData() {
        ...
        if (enablePage) {
            ...
            tipLayout.setEanableLoadMore(false);
        }
    ...
    public boolean enablePage(boolean enablePage) {
        return this.enablePage =enablePage;
    }
    ...
    public void setEnableRefresh(boolean enableRefresh) {
        tipLayout.setEanableRefresh(enableRefresh);
    }
