        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            if (switchPowerService == null) {
                try {
                    ...
                    Toast.makeText(LightActivity.this, "Registering UPnP BinaryLight device", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(LightActivity.this, "Creating of BinaryLight failed, check the log!", Toast.LENGTH_SHORT).show();
                    return;
                }
            }
