...
public class UpnpUtil {
    ...
    public static UDN uniqueSystemIdentifier(String salt) {
        ...
        //Log.d(TAG,  "host:" +AppUtils.getLocalIpAddress().getHostName()+ " ip:" +   AppUtils.getLocalIpAddress());
        try {
            if (AppUtils.getLocalIpAddress() != null) {
                systemSalt.append(AppUtils.getLocalIpAddress());
            }
