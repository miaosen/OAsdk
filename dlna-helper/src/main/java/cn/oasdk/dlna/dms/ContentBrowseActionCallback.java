...
//                                       Container container, ArrayList<ContentItem> list) {
...
//        L.i("============Received browse action DIDL descriptor, creating tree nodes===========");
//        try {
//            list.clear();
//            // Containers first
//            for (Container childContainer : didl.getContainers()) {
//                L.i("add child container "
//                        + childContainer.getTitle());
//                list.add(new ContentItem(childContainer, service));
//            }
//            // Now items
//            for (Item childItem : didl.getItems()) {
//                L.i("add child item" + childItem.getTitle());
//                list.add(new ContentItem(childItem, service));
//            }
//        } catch (Exception ex) {
//            L.i("Creating DIDL tree nodes failed: " + ex);
...
//        }
//        L.i("============received==========="+ list);
//        L.i("============received==========="+ list.get(0).getItem());
