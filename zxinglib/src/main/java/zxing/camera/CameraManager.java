...
public final class CameraManager {
	...
	private static int MAX_FRAME_HEIGHT = 960;
	...
	public static void init(Context context) {
		if (cameraManager == null) {
			...
			MAX_FRAME_WIDTH = (int) (wm.getDefaultDisplay().getWidth());
			MAX_FRAME_HEIGHT = (int) (MAX_FRAME_WIDTH * ((float) 6 / 8));
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			// Log.d("mydebug", Integer.toString(screenResolution.x));
			// Log.d("mydebug", Integer.toString(screenResolution.y));
			// Log.d("mydebug", Integer.toString(leftOffset));
			// Log.d("mydebug", Integer.toString(topOffset));
